...
class Test_HGVSNormalizer(unittest.TestCase):
    ...
    def test_c_normalizer(self):
        ...
        self.assertEqual(
            str(
                self.norm.normalize(self.hp.parse_hgvs_variant("NM_001166478.1:c.2_7delinsTTTAGA"))
            ),
        ...
        self.assertEqual(
            str(
                self.norm5.normalize(self.hp.parse_hgvs_variant("NM_001166478.1:c.2_7delinsTTTAGA"))
            ),
            "NM_001166478.1:c.3_4delinsTT",
        )
        self.assertEqual(
        ...
        self.assertEqual(
            str(
                self.norm5.normalize(self.hp.parse_hgvs_variant("NM_001166478.1:c.36_37insTCTCTC"))
            ),
