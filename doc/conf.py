...
html_sidebars = {
    '**':  ['globaltoc.html', 'relations.html', 'sourcelink.html', 'searchbox.html', 'instlogo.html']
    }
...
latex_documents = [
  ('index', 'UTA.tex', u'UTA Documentation',
   u'Reece Hart', 'manual'),
]
...
texinfo_documents = [
  ('index', 'UTA', u'UTA Documentation',
   u'Reece Hart', 'UTA', 'One line description of project.',
   'Miscellaneous'),
]
