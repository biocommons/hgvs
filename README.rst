...
`Source`_ | `Documentation`_ | `Change Log <changelog>`_ | `Mailing List`_ | `iss`_

XX |pypi_badge| |rtd_badge| |build_status|
...
.. _iss: https://bitbucket.org/biocommons/hgvs/issues?status=new&status=open
