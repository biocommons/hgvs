...
`Source`_ | `Documentation`_ | `Change Log <changelog>`_ | `Issues`_ | `Mailing List`_ | |pypi_badge| |rtd_badge| |build_status|
...
.. _issues: https://bitbucket.org/biocommons/hgvs/issues?status=new
