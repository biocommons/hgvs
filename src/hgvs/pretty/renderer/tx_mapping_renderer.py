...
class TxMappingRenderer(BasicRenderer):
    ...
    def display(self, data: VariantData) -> str:
            ...
            for pdata in data.position_details:
                ...
                elif prev_c_pos and prev_c_pos == c_pos and pdata.c_offset > 0 and (pdata.c_offset % 10) == 0:
                    var_str += "^"
                    prev_c_pos = c_pos
                    continue
                elif prev_c_pos and prev_c_pos == c_pos and pdata.c_offset > 0 and (pdata.c_offset % 5) == 0:
                    var_str += "."
                    prev_c_pos = c_pos
                    continue
